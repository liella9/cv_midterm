...
# for ResNet-18 and 34, using two 3 * 3 conv kernels
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        # if dimensions do not align, do 1 * 1 convolution and batch normalization
...
# for ResNet-50, 101 and 152, using two 1 * 1 and one 3 * 3 conv kernels
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        out = F.relu(self.bn1(self.conv1(x)))
        # out = self.conv1(x)
        # out = F.leaky_relu(self.bn1(out), negative_slope=0.01)
